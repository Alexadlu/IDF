...
class enhance_net_nopool_v2(nn.Module):
	...
	def __init__(self):
		...
		self.e_conv5 = nn.Conv2d(number_f*2,number_f,3,1,1,bias=True) 
		self.e_conv6 = nn.Conv2d(number_f*2,number_f,3,1,1,bias=True) 
		self.e_conv7 = nn.Conv2d(number_f*2,36,3,1,1,bias=True) 
	...
	def forward(self, x):
		...
		x6 = self.relu(self.e_conv6(torch.cat([x2,x5],1)))
		x_r = F.tanh(self.e_conv7(torch.cat([x1,x6],1)))
		r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12 = torch.split(x_r, 3, dim=1)
		...
		enhance_image = x + r12*(torch.pow(x,2)-x)
		r = torch.cat([r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12],1)
		return enhance_image, r
