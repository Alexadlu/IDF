...
nohup python train_bodnet.py --gpu_ids 0 --name ft_ResNet50 --train_all --batchsize 32 >train_IDF_ide_kl01_rec01_bs32.file 2>&1 &
...
python test_IDF_model.py --gpu_ids 3 #--name ft_ResNet50 --test_dir your_data_path  --batchsize 32 --which_epoch 59
